...
A comprehensive collection of Claude Code skills for academic research in economics, finance, and social sciences.

## Overview

This repository contains specialized skills designed to assist with various stages of the academic research workflow, from ideation to publication.

## Skill Categories

### Writing & Drafting
- **academic-writing** - Academic writing methodology and best practices
- **scientific-writing** - Core scientific writing skill
- **econ-write** - Expert economics paper writing assistant
- **academic-paper-write** - Academic paper writing support

### Literature Review
- **lit-review** - Literature review assistance
- **literature-review** - Comprehensive literature review tools
- **academic-researcher** - Academic research assistant for literature

### Data Analysis
- **r-analyst** - R statistical analysis for publication
- **stata-analyst** - Stata data analysis
...
- **data-analysis** - End-to-end data analysis
...
### Data Sources
- **fred-economic-data** - Federal Reserve Economic Data access
- **sec-edgar-parser** - SEC EDGAR filings parser
- **api-data-fetcher** - API data retrieval

### Grants & Proposals
- **research-grants** - Research proposal writing
...
### Other Tools
- **newproject** - Scaffold new research projects
- **paper-plot-skills-main** - Paper plotting utilities
- **paper-2-web** - Convert papers to web format
- **market-research-reports** - Market research reports
- **interview-me** - Interview preparation
- **consistency-checker** - Document consistency checking
- **excalidraw-diagram-skill-main** - Diagram creation
